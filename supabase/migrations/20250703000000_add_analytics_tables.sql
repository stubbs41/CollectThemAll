...
DROP POLICY IF EXISTS "Anyone can view comments on a shared collection" ON public.collection_comments;
...
DROP POLICY IF EXISTS "Users can create comments on shared collections that allow comments" ON public.collection_comments;
...
DROP POLICY IF EXISTS "Users can update their own comments" ON public.collection_comments;
...
DROP POLICY IF EXISTS "Users can delete their own comments" ON public.collection_comments;
...
DROP POLICY IF EXISTS "Collection owners can delete any comments on their collections" ON public.collection_comments;
...
-- Create analytics table for shared collections if it doesn't exist
...
DROP POLICY IF EXISTS "Anyone can create analytics events" ON public.collection_analytics;
...
DROP POLICY IF EXISTS "Collection owners can view analytics" ON public.collection_analytics;
